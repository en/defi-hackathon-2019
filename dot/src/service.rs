...
use babe;
use dot_runtime::{self, opaque::Block, GenesisConfig, RuntimeApi};
use futures::prelude::*;
...
native_executor_instance!(
	pub Executor,
	dot_runtime::api::dispatch,
	dot_runtime::native_version,
);
...
macro_rules! new_full_start {
    ($config:expr) => {{
        ...
        let builder = substrate_service::ServiceBuilder::new_full::<
            dot_runtime::opaque::Block,
            dot_runtime::RuntimeApi,
        ...
        .with_import_queue(|_config, client, mut select_chain, _transaction_pool| {
            ...
            let (grandpa_block_import, grandpa_link) =
                grandpa::block_import::<_, _, _, dot_runtime::RuntimeApi, _, _>(
                    client.clone(),
                    &*client,
                    select_chain,
                )?;
