...
use multidao_runtime::{self, opaque::Block, GenesisConfig, RuntimeApi};
...
native_executor_instance!(
	pub Executor,
	multidao_runtime::api::dispatch,
	multidao_runtime::native_version,
);
...
macro_rules! new_full_start {
    ($config:expr) => {{
        ...
        let builder = substrate_service::ServiceBuilder::new_full::<
            multidao_runtime::opaque::Block,
            multidao_runtime::RuntimeApi,
        ...
        .with_import_queue(|_config, client, mut select_chain, _transaction_pool| {
            ...
            let (grandpa_block_import, grandpa_link) =
                grandpa::block_import::<_, _, _, multidao_runtime::RuntimeApi, _, _>(
                    client.clone(),
                    &*client,
                    select_chain,
                )?;
